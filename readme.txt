...
1) Install Maven globally on your computer (of course no need to do this if it's already installed)
2) Download the repository (https://github.com/exerciseaccount/javarestassured.git)
3) Go to the main project directory (that would be /javarestassured, and inside of it you should see the pom.xml file among others)
4) Execute the following commands (one at the time):
mvn clean
mvn compile
mvn test
